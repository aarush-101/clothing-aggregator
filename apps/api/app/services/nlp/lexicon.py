...
COLOUR_SYNONYMS: Dict[str, Set[str]] = {
    ...
    "cream": {"cream", "ecru", "off-white", "off white", "ivory", "bone", "chalk", "oat", "oatmeal"},
...
CATEGORY_SYNONYMS: Dict[str, Set[str]] = {
    "shirt": {"shirt", "shirts", "button-up", "button up", "button-down", "oxford shirt", "camp collar"},
...
STOPWORDS: Set[str] = {
    "a", "an", "and", "the", "for", "with", "that", "this", "some", "any", "me",
    "i", "my", "of", "to", "in", "on", "at", "is", "are", "be", "im", "want",
    "need", "looking", "look", "find", "show", "get", "buy", "shop", "please",
    "something", "anything", "like", "similar", "under", "below", "over",
    "less", "than", "more", "about", "around", "up", "it", "its", "would",
    "can", "you", "your", "us", "we", "or", "but", "very", "really", "just",
    "good", "nice", "great", "best", "new", "from", "by", "out", "all",
    "size", "sized", "ships", "ship", "shipping", "deliver", "delivery",
    "not", "no", "except", "excluding", "avoid", "without", "other", "apart",
    "sale", "discount", "discounted", "deal", "deals", "clearance", "reduced",
    "price", "cheap", "cheaper", "cheapest", "budget", "max", "maximum",
    "minimum", "min", "dollars", "dollar", "aud", "usd", "outfit", "men",
    "mens", "man", "male", "wear", "wearing",
}
...
CITY_COUNTRY: Dict[str, str] = {
    ...
    "new york": "US", "nyc": "US", "los angeles": "US", "chicago": "US",
    "toronto": "CA", "vancouver": "CA",
    "singapore": "SG", "tokyo": "JP", "berlin": "DE", "paris": "FR",
}
COUNTRY_NAMES: Dict[str, str] = {
    "australia": "AU", "new zealand": "NZ", "united kingdom": "GB", "uk": "GB",
    "england": "GB", "united states": "US", "usa": "US", "america": "US",
    "canada": "CA", "singapore": "SG", "japan": "JP", "germany": "DE", "france": "FR",
}
